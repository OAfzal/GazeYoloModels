...
def run():
    ...
    logger = Logger(Config.log_dir)  # Tensorboard logger

    # Create output directories if missing
    os.makedirs(Config.ckpt_dir, exist_ok=True)

    # Get data configuration
    data_config = parse_data_config(Config.data_file)
    ...
    model = load_model(Config.model_def, Config.pretrained_weights)
